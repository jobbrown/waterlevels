...
abstract public class ReadingHelper
{
    ...
    if (__typeCode == null)
    {
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _tcOf_members0 = com.jobbrown.sensor.corba.DateTimeHelper.type ();
  ...
  public static com.jobbrown.sensor.corba.Reading read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.date = com.jobbrown.sensor.corba.DateTimeHelper.read (istream);
  ...
  {
    com.jobbrown.sensor.corba.DateTimeHelper.write (ostream, value.date);
