 ...
 implements com.jobbrown.sensor.corba.SensorOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Sensor/Sensor/getLog
       {
         String $result[] = null;
         $result = this.getLog ();
         out = $rh.createReply();
         com.jobbrown.sensor.corba.LogHelper.write (out, $result);
         break;
       }

       case 1:  // Sensor/Sensor/currentReading
       {
       ...
       case 2:  // Sensor/Sensor/isFlooding
       {
       ...
       case 3:  // Sensor/Sensor/checkAlarmStatus
       {
       ...
       case 6:  // Sensor/Sensor/_get_name
       {
         String $result = null;
         $result = this.name ();
         out = $rh.createReply();
       ...
       case 7:  // Sensor/Sensor/_set_name
       {
       ...
       case 8:  // Sensor/Sensor/_get_zone
       {
         String $result = null;
         $result = this.zone ();
         out = $rh.createReply();
       ...
       case 9:  // Sensor/Sensor/_set_zone
       {
       ...
       case 10:  // Sensor/Sensor/_get_waterLevel
       {
         int $result = (int)0;
       ...
       case 11:  // Sensor/Sensor/_set_waterLevel
       {
       ...
       case 12:  // Sensor/Sensor/_get_alarmLevel
       {
         int $result = (int)0;
       ...
       case 13:  // Sensor/Sensor/_set_alarmLevel
       {
       ...
       case 14:  // Sensor/Sensor/_get_active
       {
         boolean $result = false;
         $result = this.active ();
         out = $rh.createReply();
       ...
       case 15:  // Sensor/Sensor/_set_active
       {
       ...
       case 16:  // Sensor/Sensor/_get_readings
       {
         com.jobbrown.sensor.corba.Reading $result[] = null;
       ...
       case 17:  // Sensor/Sensor/_set_readings
       {
